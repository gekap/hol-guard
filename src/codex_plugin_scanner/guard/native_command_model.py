"""Python transport for the native command model and PreToolUse authority.

Supported command PreToolUse decisions come from the Rust runtime. This module
validates and returns that native result; it does not parse, classify, or lower
the semantic decision. Command-model shadow comparison remains a separate
parser-evidence path and is not a PreToolUse authority.
"""
